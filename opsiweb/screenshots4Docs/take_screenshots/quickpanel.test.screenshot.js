...
test('Quick Panel', async ({ page }) => {
  ...
  component1.click()
  await (await page.locator('#qp-tab-depots > .scrollcontent')).screenshot({ path: './screenshots/de/opsi-webgui_quickpanel_tab_depots_content.png' })
  ...
  component2.click()
  await (await page.locator('#qp-tab-clients')).screenshot({ path: './screenshots/de/opsi-webgui_quickpanel_tab_clients_content.png' })
  ...
  component3.click()
  await (await page.locator('#qp-tab-products')).screenshot({ path: './screenshots/de/opsi-webgui_quickpanel_tab_products_content.png' })
  ...
  component0.click()
  await (await page.locator('.tab-content')).screenshot({ path: './screenshots/de/opsi-webgui_quickpanel_tab_selection_content.png' })
})
