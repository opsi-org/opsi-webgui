...
test('Product Dependencies', async ({ page }) => {
  ...
  await page.setViewportSize({ width: 900, height: 170 })
  ...
  await page.evaluate((val) => { document.querySelector('.reqType').innerHTML = val }, en['table.fields.pre-required'])
  ...
  await page.evaluate((val) => { document.querySelector('.reqType').innerHTML = val }, de['table.fields.pre-required'])
