...
test.describe('Client On Demand', () => {
  test('Button with label', async ({ page }) => {
    ...
    await component.screenshot({ path: './screenshots/en/opsiweb_buttonclientondemand.png' })
    await page.evaluate((val) => { document.querySelector('.eventlabel').innerHTML = val }, de['button.event.ondemand'])
    await component.screenshot({ path: './screenshots/de/opsiweb_buttonclientondemand.png' })
  })
  ...
  test('Button', async ({ page }) => {
    ...
    const component = await page.locator('[data-testid="BTNEvent"]')
    await (new Promise(resolve => setTimeout(resolve, 1000)))
    await component.screenshot({ path: './screenshots/en/opsiweb_iconclientondemand.png' })
    await component.screenshot({ path: './screenshots/de/opsiweb_iconclientondemand.png' })
  })
  test('Modal', async ({ page }) => {
    ...
    await component.screenshot({ path: './screenshots/en/opsiweb_clientondemand.png' })
    ...
    await component.screenshot({ path: './screenshots/de/opsiweb_clientondemand.png' })
  })
})
