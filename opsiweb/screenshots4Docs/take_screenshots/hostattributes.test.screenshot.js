...
test('Host Attributes', async ({ page }) => {
  ...
  await component.screenshot({ path: './screenshots/en/opsi-webgui_hostattributes.png' })
  ...
  await component.screenshot({ path: './screenshots/de/opsi-webgui_hostattributes.png' })
})
