...
test.describe('Track Changes', () => {
  ...
  test('Modal', async ({ page }) => {
    ...
    await page.evaluate((val) => { document.querySelector('.filterchanges').placeholder = val }, en['filterBy.DepotsClients'])
    ...
    await page.evaluate((val) => { document.querySelector('.filterchanges').placeholder = val }, de['filterBy.DepotsClients'])
