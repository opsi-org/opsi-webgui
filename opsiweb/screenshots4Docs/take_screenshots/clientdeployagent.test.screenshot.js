...
test('Client Deploy Agent', async ({ page }) => {
  ...
  await page.screenshot({ path: './screenshots/en/opsiweb_clientdeployagent.png' })
  ...
  await page.screenshot({ path: './screenshots/de/opsiweb_clientdeployagent.png' })
})
