...
test.describe('Client Deploy Agent', () => {
  test('Button', async ({ page }) => {
    ...
    await component.screenshot({ path: './screenshots/en/opsiweb_buttonclientdeployagent.png' })
    await page.evaluate((val) => { document.querySelector('.clientagent').innerHTML = val }, de['label.clientagent'])
    await component.screenshot({ path: './screenshots/de/opsiweb_buttonclientdeployagent.png' })
  })
  test('Modal', async ({ page }) => {
    ...
    await component.screenshot({ path: './screenshots/en/opsiweb_clientdeployagent.png' })
    ...
    await component.screenshot({ path: './screenshots/de/opsiweb_clientdeployagent.png' })
  })
})
