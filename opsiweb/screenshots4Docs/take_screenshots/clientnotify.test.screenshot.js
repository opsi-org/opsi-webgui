...
test('Client notify', async ({ page }) => {
  ...
  await page.screenshot({ path: './screenshots/en/opsiweb_clientnotify.png' })
  ...
  await page.screenshot({ path: './screenshots/de/opsiweb_clientnotify.png' })
})
