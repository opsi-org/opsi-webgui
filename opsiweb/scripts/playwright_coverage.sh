...
printf "TESTED FILES\t\t: $PERCENTAGE_COVERAGE%% ($NUM_TESTED_FILES/$NUM_FILES)\n"
printf "SUCCESSFUL TESTS\t: $PERCENTAGE_SUCCESS%% ($NUM_TESTS_SUCCESS/$NUM_TESTS)\n"
printf "FAILED TESTS\t\t: $PERCENTAGE_FAILED%% ($NUM_TESTS_FAILED/$NUM_TESTS)\n"
echo "============================================"
