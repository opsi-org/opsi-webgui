...
test.describe('Manage', () => {
  ...
  test('Clients', async ({ page }) => {
    ...
    await page.evaluate((val) => { document.querySelector('.tableheader_products').innerHTML = val }, en['treeselect.prodGroups'])
    ...
    await page.evaluate((val) => { document.querySelector('.tableheader_products').innerHTML = val }, de['treeselect.prodGroups'])
