...
test('dropdown lang snapshot', async ({ page }) => {
  ...
  expect(await component.screenshot()).toMatchSnapshot('dropdown-ddlang-normal.png')
})
...
test('dropdown lang opened snapshot', async ({ page }) => {
  ...
  expect(await component.screenshot()).toMatchSnapshot('dropdown-ddlang-opened.png')
})
