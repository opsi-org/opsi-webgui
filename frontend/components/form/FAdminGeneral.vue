        ...
        <el-form-item v-for="(action, index) in actions" :key="index" :label="$t(action)">
          <div :style="mq.isMobile.value ? '' : 'display: flex; align-items: center;'">
            <el-select
              ...
              :disabled="section == 'clients' ? !hasBlockedClients : !hasLockedProducts"
              :placeholder="section === 'clients' ? placeholderClients : placeholderProducts"
            >
              <el-option
            ...
            <el-button
              :disabled="
                ((action === 'unblock' || action === 'unlock') && selected[section] == '') ||
                section == 'clients'
                  ? !hasBlockedClients
                  : !hasLockedProducts
              "
