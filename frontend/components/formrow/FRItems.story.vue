...
<script setup lang="ts">
  ...
  const items = {
    'bool-false': {
      ...
      type: 'BoolConfig' as tconfigtypes,
      value: false,
  ...
  const changeItem = (item: any, v: any) => {
    changeValue(item, v)
  }
</script>
<template>
  <Story>
    <Variant title="mobile" :meta="{ wrapperMobile: true }" responsive-disabled>
      <FormrowFRItems
        :items="[
          items['unicode-empty'],
          items['unicode-single-edit'],
          items['unicode-single-noedit'],
          items['unicode-multi-edit'],
          items['unicode-multi-noedit'],
        ]"
