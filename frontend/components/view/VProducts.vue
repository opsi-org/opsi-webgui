...
const tableColumn = ref([
  ...
  {title: $t('table.fields.actionResult'), key: 'actionResult', sortable: true, visible: clientSelection.value.length > 0, width: "80px", icon: icons.productActionResult, cellRenderer: ({rowData}: any) => {
        return (
          <>
  ...
  {title: $t('table.fields.productId'), key: 'productId', sortable: true, alwaysVisible: true, visible: true, filter: true},
  ...
  {title:  $t('table.fields.modificationTime'), key: 'modificationTime', sortable: true, visible: false},
  {title:  $t('table.fields.priority'), key: 'priority', sortable: true, visible: false},
  {title:  $t('table.fields.version'), key: 'version', sortable: true, visible: false, cellRenderer: ({rowData}: any) => {
        const tt = (
          <>
            <ul>
  ...
  {title:  $t('table.fields.actionProgress'), key: 'actionProgress', sortable: true, visible: clientSelection.value.length > 0},
  {title:  $t('table.fields.actionRequest'), key: 'actionRequest', sortable: true, visible: clientSelection.value.length > 0, headerCellRenderer: (useMQ().isMobile.value) ? undefined : () => {
        return ( <>
