...
export const apiMock = (page: Page, apiPath: string, response: any, additionalHeaders={}, consigserverName='testconfigserver') => {
...
export const mockEveryThing = (test: any, expect: any) => {
  ...
  const mockData = async ({ page }: any) => {
    ...
    apiMock(page, '**/api/opsidata/products/groups**', { groups: data.groups.productgroups })
