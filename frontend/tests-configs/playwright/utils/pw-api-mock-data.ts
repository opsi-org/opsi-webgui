...
const depotIds:Array<string> = ['configserver.domain.local', 'depot1.domain.local', 'depot2.domain.local', 'depot3.domain.local']
const depotObjs:Array<any> = [{ depotId: depotIds[0], ident: depotIds[0], type: 'OpsiConfigserver', ip: '192.168.12.3', description: '', selected: 0 }]
...
const productIds:Array<string> = ['Windows Activation', 'config-win-base', 'config-win10', 'onfig-win81-desktop', 'hwaudit', 'jedit', 'l-debuntu-upgrde', 'l-desktop', 'l-opsi-server', 'l-opsi-server-migrate', 'l-opsi-server-register-depot', 'l-os-postinst', 'l-ssh-root-login', 'l-system-upgrade', 'l-virtualbox', 'networklocation', 'l-opsi-auto-update']
