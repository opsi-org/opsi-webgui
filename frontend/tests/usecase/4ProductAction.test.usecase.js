...
//   // expect(session).toEqual(cookieOpsiconfdSession) // in ci it will work, but locally we may have more cookies
...
//       // await page.screenshot({ path: './tests-screenshots/quicksave-off.png' })
...
//       await (new Promise(resolve => setTimeout(resolve, 1000)))
//       // await page.screenshot({ path: './tests-screenshots/products.png' })
...
//       await expect(page).toHaveURL('/addons/webgui/app/settings')
//       await page.getByTestId('CBQuickSave').check()
//       // await page.screenshot({ path: './tests-screenshots/quicksave-on.png' })
//       await page.click('[data-testid="NIItem-title.products"]')
//       await expect(page).toHaveURL('/addons/webgui/app/products/LocalbootProducts')
//       await (new Promise(resolve => setTimeout(resolve, 1000)))
//       const row = page.locator('tr:has-text("activate-win")')
