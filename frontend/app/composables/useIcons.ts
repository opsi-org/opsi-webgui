...
export const icons = {
  ...
  productsOutdated: 'heroicons:exclamation-triangle',
  ...
  inventory: 'heroicons:clipboard-document-check',
  hardware: 'heroicons:cpu-chip',
  software: 'heroicons:archive-box',
  motherboard: 'mdi:motherboard',
  chassis: 'mdi:desktop-tower',
  memory: 'mdi:memory',
  ...
  usb: 'mdi:usb',
  commandLine: 'heroicons:command-line',
  ...
  starSolid: 'heroicons:star-solid',
  star: 'heroicons:star',
