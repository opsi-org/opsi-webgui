<!--
  ...
  ClientInventoryPage - Route page for viewing client hardware/software inventory with optional client ID.
-->
<template>
  <div class="h-full">
...
<script setup lang="ts">
  ...
  useHead({ title: () => `${$t('inventory.title')} - OPSI-WebGUI` })
  ...
  function updateClientId(id: string | null) {
    ...
    const target = id ? `/clients/inventory/${id}` : '/clients/inventory'
