        ...
        <div
            ...
            <div class="relative w-9 h-9 flex items-center justify-center overflow-visible">
                ...
                <span
                    ...
                    <UIcon :name="restricted ? icons.lock : icons.check" class="w-3 h-3"
...
const colorClasses = computed(() => props.restricted
    ? { bg: 'bg-(--color-warning-soft-bg)', text: 'text-(--color-warning-soft-text)', badge: 'bg-(--color-warning)', badgeIcon: 'text-(--color-warning-text)' }
    : { bg: 'bg-(--color-success-soft-bg)', text: 'text-(--color-success-soft-text)', badge: 'bg-(--color-success)', badgeIcon: 'text-(--color-success-text)' },
)
</script>
