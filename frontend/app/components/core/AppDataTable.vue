...
<template>
  <div
    class="data-table flex flex-col h-full min-h-0 min-w-0"
    :class="{ 'data-table--compact': isCompactDensity }"
  >
    <div class="shrink-0 flex flex-wrap items-center justify-between gap-1.5 mb-1.5">
      ...
      <div class="flex items-center gap-2">
        ...
        <UPopover v-model:open="tableSettingsOpen">
          ...
          <template #content>
            <div
              class="p-2.5 min-w-96 overflow-y-auto bg-(--color-background) rounded shadow-lg"
            >
              ...
              <div class="mb-3 grid grid-cols-[6.5rem_1fr] items-center gap-x-2 gap-y-2.5">
                ...
                <div class="flex gap-0.5">
                  <UButton
                    ...
                    :color="'primary'"
                    :variant="
                      tableSettings.settings.displayMode === 'infinite' ? 'solid' : 'outline'
                    "
                  ...
                  <UButton
                    ...
                    :color="'primary'"
                    :variant="
                      tableSettings.settings.displayMode === 'pagination' ? 'solid' : 'outline'
                    "
          ...
          <table class="w-max min-w-full" role="grid">
            ...
            <tbody class="data-table-body" :class="{ 'pb-2': displayMode === 'pagination' }">
              ...
              >
                ...
                >
                  <slot
                    :name="`cell-${col.key}` as any"
                    :row="row"
                    :value="getNestedValue(row, col.key)"
                    :index="idx"
                  >
                    <CoreAppTooltip
                      v-if="col.tooltip && getTooltipValue(row, col)"
                      :text="getTooltipValue(row, col)"
                    >
              ...
              <tr
                v-if="displayMode === 'infinite' && hasMoreData"
                ref="scrollSentinel"
