  ...
  <div class="flex flex-col h-full min-h-0">
    ...
    <div class="mt-auto shrink-0 border-t border-(--color-border) pt-1.5 space-y-2.5">
      ...
      <div class="border-t border-(--color-border) pt-1.5" data-testid="quickpanel-settings-section">
        ...
        <div class="space-y-1">
          <div
            class="flex items-center justify-between gap-1.5 py-1 rounded hover:bg-(--color-surface-hover) transition-colors">
            <CoreAppTooltip :text="(messageBusStore.isConnected ? $t('bus.connected') : $t('bus.disconnected')) +
              ' - ' +
              $t('settings.autoRefreshTooltip')
              ">
              <div class="flex items-center gap-5 cursor-help pl-0.5">
                ...
                <div class="flex flex-col">
                  ...
                  <span class="text-xs font-medium" :class="messageBusStore.isConnected
