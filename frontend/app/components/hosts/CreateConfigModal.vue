			...
			<CoreAppCard class="min-w-96">
				...
				<div class="space-y-4">
					<div>
						...
						<CoreAppInput v-model="newConfig.configId" :placeholder="String($t('config.idPlaceholder'))"
							size="sm" />
					</div>
					<div>
					...
					<div v-if="newConfig.type === 'UnicodeConfig'">
						...
						<div class="flex gap-1">
							<CoreAppInput v-model="newPossibleValue" :placeholder="$t('common.pressEnterToAdd')"
								size="sm" class="flex-1" @keydown.enter.prevent="addPossibleValue" />
							<CoreAppButton size="sm" variant="outline" color="primary" :icon="icons.add"
					...
					<div v-if="newConfig.type === 'UnicodeConfig'">
						...
						<div class="flex gap-1">
							<CoreAppInput v-model="newDefaultValue" :placeholder="$t('common.pressEnterToAdd')"
								size="sm" class="flex-1" @keydown.enter.prevent="addDefaultValue" />
							<CoreAppButton size="sm" variant="outline" color="primary" :icon="icons.add"
				...
				<template #footer>
					<div class="flex gap-2 justify-end">
						<CoreAppButton variant="ghost" color="neutral" @click="handleClose">{{ $t('common.cancel') }}
						</CoreAppButton>
