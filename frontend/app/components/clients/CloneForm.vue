  ...
  <template v-else>
    <div class="shrink-0 pb-2 sticky top-0 z-10 bg-(--color-surface) mb-2">
      <div class="flex flex-wrap items-center gap-2">
        <div v-if="showSourceSelector" class="flex items-center gap-1.5">
          <slot name="sourceSelector">
            <HostsSelector
              v-model="sourceSelectorModel"
              type="client"
              :placeholder="sourceSelectorPlaceholder"
              :allow-all="false"
              allow-clear
            />
          </slot>
    ...
    <CoreAppEmptyState
      v-if="!resolvedSourceId && !loading"
      :icon="icons.client"
      :message="String($t('clients.selectClone'))"
      class="flex-1"
    />
    ...
    <div v-else :class="['flex-1 overflow-y-auto space-y-3 opsi-dense-form opsi-compact-page']">
      ...
      <div class="opsi-card">
        <div class="flex items-center justify-between mb-2">
          <h4 class="text-xs font-heading uppercase tracking-wide m-0">
        ...
        <div>
          ...
          >
            ...
            <div class="flex-1">
              <CoreAppInput
                v-model="cloneclient.target.ipAddress"
                :disabled="loading"
                size="sm"
          ...
          >
            ...
            <div class="flex-1">
              <CoreAppInput
                v-model="cloneclient.target.hardwareAddress"
                :disabled="loading"
                size="sm"
          ...
          >
            ...
            <div class="flex-1">
              <CoreAppInput
                v-model="cloneclient.target.systemUUID"
                :disabled="loading"
                size="sm"
                :placeholder="String($t('fields.uuidExample'))"
                class="w-full"
              />
            </div>
          </div>
